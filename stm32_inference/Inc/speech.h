...
/******************************************************************************/
#define AI_SPEECH_MODEL_NAME          "speech"
#define AI_SPEECH_ORIGIN_MODEL_NAME   "model_onnx_8000hz"

/******************************************************************************/
#define AI_SPEECH_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SPEECH_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SPEECH_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_SPEECH_IN_NUM        (1)

AI_DEPRECATED
#define AI_SPEECH_IN \
  ai_speech_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_SPEECH_IN_SIZE { \
  AI_SPEECH_IN_1_SIZE, \
}
#define AI_SPEECH_IN_SIZE_BYTES { \
  AI_SPEECH_IN_1_SIZE_BYTES, \
}
#define AI_SPEECH_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_SPEECH_IN_1_CHANNEL     (1)
#define AI_SPEECH_IN_1_HEIGHT      (8000)
#define AI_SPEECH_IN_1_SIZE        (1 * 8000)
#define AI_SPEECH_IN_1_SIZE_BYTES  (32000)

/******************************************************************************/
#define AI_SPEECH_OUT_NUM       (1)

AI_DEPRECATED
#define AI_SPEECH_OUT \
  ai_speech_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_SPEECH_OUT_SIZE { \
  AI_SPEECH_OUT_1_SIZE, \
}
#define AI_SPEECH_OUT_SIZE_BYTES { \
 ...
 * @ref ai_speech_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_speech_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_speech_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_SPEECH_*
 * defines into file @ref speech.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
